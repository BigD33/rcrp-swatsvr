...
new aWeaponNames[47][] = {
	"None","Brass Knuckles","Golf Club","Nitestick","Knife","Baseball Bat","Shovel","Pool Cue","Katana","Chainsaw","Purple Dildo","Small White Vibrator","Large White Vibrator","Silver Vibrator",
	"Bouquet of Flowers","Cane","Grenade","Tear Gas","Molotov Cocktail","Jetpack"," "," ","Colt .45","Silenced Colt .45","Desert Eagle","12-Gauge Shotgun","Sawn-Off Shotgun","SPAS-12",
	"Micro Uzi","MP5","AK-47","M4","TEC-9","Country Rifle","Sniper Rifle","Rocket Launcher","Heatseeking Rocket Launcher","Flamethrower","Minigun","Satchel Charge","Detonator","Spray Can","Fire Extinguisher",
